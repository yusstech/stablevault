        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div>
            ...
            >
              ...
              <br />
              <span className="text-white/40">Instantly. Anywhere.</span>
            </motion.h1>
            ...
            >
              You did the work. You sent the invoice. Now you&apos;re waiting... again. Relyr ends the waiting.
            </motion.p>
            ...
            >
              <div className="flex items-center gap-2">
                ...
                <span>No PayPal restrictions</span>
              </div>
              <div className="flex items-center gap-2">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
          ...
          {/* Visual - Payment notification mockup */}
          <motion.div
            ...
            <div className="relative bg-gradient-to-br from-gray-900 to-black rounded-3xl p-8 border border-white/10 shadow-2xl">
              ...
              >
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-white/60 text-sm">From: Creative Agency LLC</p>
                  </div>
                </div>
                <div className="mt-4 pt-4 border-t border-success-green-500/20">
                  <p className="text-3xl font-bold text-white mb-1">$2,500.00 USD</p>
                  <p className="text-white/60 text-sm">≈ ₦2,000,000</p>
                </div>
              </motion.div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-white/5 rounded-xl p-4">
                  <p className="text-white/60 text-xs mb-1">Time to receive</p>
                  <p className="text-white font-bold text-lg">3 minutes</p>
                </div>
                <div className="bg-white/5 rounded-xl p-4">
                  <p className="text-white/60 text-xs mb-1">Fees saved</p>
                  <p className="text-success-green-500 font-bold text-lg">$75</p>
                </div>
              </div>
            </div>
