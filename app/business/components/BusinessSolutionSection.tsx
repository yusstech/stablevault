  ...
  const solutions = [
    {
      ...
      description: 'Send money to suppliers in China, Dubai, UK, US — anywhere. They receive it same day. You get tracking and proof of payment instantly. Build better supplier relationships with reliable, fast payments.',
      icon: (
